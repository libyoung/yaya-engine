...
dual_Call=  ["Launch dailer pad",OpenAPP('Dialer'),
             "Open the dailer pad",SWITCH2[{'resourceId':'com.android.dialer:id/floating_action_button'}],
...
Test_enter_into_call=["Test_enter_into_call","Step1 Launch dailer pad",OpenAPP('Dialer'),
                      ...
                      "Open dailer pad",SWITCH2[{'resourceId':'com.android.dialer:id/floating_action_button'}],
                      'call number',CallNumber("10010"),
...
Test_Call_from_search=["Test_Call_from_search","Open dialer",OpenAPP("Dialer"),
                       ...
                       "Click the serach",SWITCH2[{"textContains":"1"}],
                       "Mdevice is incall",IsInCall(5),
                       "Stay call connect 5s", InCallStay(5),
...
Test_merage_call=["Test_merage_call","Launch dailer pad",OpenAPP('Dialer'),
                  "Open dialer pad",SWITCH2[{'resourceId':'com.android.dialer:id/floating_action_button'}],
                 'call number',CallNumber("18651502758"),
                 'Check if the MDevice is incall status', IsInCall(8),
                 'Switch SDevice and Answer Call', SDevice( IsRinging(10), CallAnswer ),
...
Test_reply_Call_from_notification=["Test_reply_Call_from_notification","Mdevice open notification",OpenNotification,
                                   "Mdevice clear all",SWITCH2[{"text":"CLEAR ALL"}],
                                   "SDevice launch diler",SDevice(
                                   "Open dialer",OpenAPP("Dialer"),SWITCH2[{'resourceId':'com.android.dialer:id/floating_action_button'}],
...
Test_call_recording_function=["Test_call_recording_function","Launch dailer pad",OpenAPP('Dialer'),SWITCH2[{'resourceId':'com.android.dialer:id/floating_action_button'}],
                            'call number',CallNumber("18651502758"),
                            'Check if the MDevice is incall status', IsInCall(8),
                            'Switch SDevice and Answer Call', SDevice( IsRinging(10), CallAnswer ),
...
Test_Call_before_edit=["Test_Call_before_edit",OpenAPP('Dialer'),SWITCH2[{'resourceId':'com.android.dialer:id/floating_action_button'}],
...
Test_check_Call_wait_status= ["Test_check_Call_wait_status","Launch dailer pad",OpenAPP('Dialer'),
                              "Open dailer",SWITCH2[{'resourceId':'com.android.dialer:id/floating_action_button'}],
...
Test_Turn_on_Call_forward=["Test_Turn_on_Call_forward","Launch dailer pad",OpenAPP('Dialer'),
                            ...
                            "Turn on or update",SWITCH2[{"text":"TURN ON"}][{"text":"UPDATE"}],
                            "Wait", Wait(4),
